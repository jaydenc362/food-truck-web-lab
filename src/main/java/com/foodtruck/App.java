...
public class App {
    ...
    public static void main(String[] args) {
        ...
        get("/", (req, res) -> {
            ...
            html += "<option value='salad_chef'>Chef Salad ($8.20)</option>";
            html += "<option value='salad_cobb'>Cobb Salad ($8.00)</option>";
            html += "</select></p>";
            ...
            html += "<option value='sandwich_peanutbutter'>Peanut Butter Sandwich ($7.00)</option>";
            html += "<option value='sandwich_cheese'>Cheese Sandwich ($6.50)</option>";
            html += "</select></p>";
            ...
            html += "<option value='drink_matcha'>Matcha ($3.45)</option>";
            html += "<option value='drink_coffee'>Coffee ($3.10)</option>";
            html += "</select></p>";
